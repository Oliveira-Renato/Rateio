      ...
      if (session) {
        try {
          ...
          if (response.data) {
            ...
            const totalExpenses = data.participants.reduce(
              (acc: number, participant: ParticipantsProps) => {
            ...
            const updatedParticipants = data.participants.map(
              (participant: ParticipantsProps) => {
                const amountOwed =
                  parseFloat(participant.expense) - individualShare;
  ...
  return (
    <div className="relative sm:mt-40 sm:mx-10 md:px-10 md:mt-0 md:mx-0 py-20 sm:h-screen">
      ...
      <h5 className="text-sm text-center mb-8">
        Não se preocupe, agora o resto é conosco 😤{" "}
      </h5>
                ...
                <div className="w-1/3">
                  ...
                  <div
                    className={`rounded-sm ${
                      participant?.owe && participant.owe >= 0
                        ? "bg-green-700 text-gray-950"
                        : "bg-red-700 text-gray-950"
                    }`}
                  >
